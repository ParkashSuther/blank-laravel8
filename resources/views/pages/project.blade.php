...
<!-- Mirrored from myadmin2.appavent.com/pages/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:41 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title>Project | Remark Admin Template</title>
...
<body class="animsition site-navbar-small page-project">
  <!--[if lt IE 8]>
      ...
      <div class="row">
        <div class="col-xxl-9 col-xl-8 col-lg-12 col-xs-12">
          <div class="card">
            <div class="card-block">
              ...
              <p class="card-text">
                Project:<a href="#" class="m-l-5">Lorem Ipsum</a>
              </p>
            </div>
            <div class="card-block">
              <ul class="project-team-items clearfix">
                <li class="team-item">
                  <a href="#" class="avatar avatar-sm m-y-5">
                    <img src="../global/portraits/4.jpg">
                  </a>
                </li>
                <li class="team-item item-divider">
                  <i class="icon md-chevron-right m-r-0"></i>
                </li>
                <li class="team-item">
                  <a class="avatar avatar-sm m-y-5 m-r-5" data-member-id="m_1">
                    <img src="../global/portraits/1.jpg" />
                  </a>
                  <a class="avatar avatar-sm m-y-5 m-r-5" data-member-id="m_2">
                    <img src="../global/portraits/2.jpg" />
                  </a>
                  <a class="avatar avatar-sm m-y-5 m-r-5" data-member-id="m_3">
                    <img src="../global/portraits/3.jpg" />
                  </a>
                  <a class="avatar avatar-sm m-y-5 m-r-5" data-member-id="m_4">
                    <img src="../global/portraits/5.jpg" />
                  </a>
                  <a class="avatar avatar-sm m-y-5 m-r-5" data-member-id="m_5">
                    <img src="../global/portraits/6.jpg" />
                  </a>
                  <a class="avatar avatar-sm m-y-5 m-r-5" data-member-id="m_6">
                    <img src="../global/portraits/7.jpg" />
                  </a>
                </li>
              </ul>
            </div>
            <div class="card-block ">
              <div class="project-controls clearfix">
                ...
                <div class="pull-xs-right">
                  ...
                  <div class="dropdown">
                    <button type="button" class="btn btn-default btn-outline dropdown-toggle m-r-0"
              ...
              <p class="card-text">
                Laborum velit adipisicing sunt mollit non. Consequat sunt irure reprehenderit proident.
                Mollit aliqua ex ullamco pariatur commodo. Aute cupidatat est eu
                sunt deserunt ipsum sit esse mollit. Occaecat do dolor dolore laboris
                minim. Tempor voluptate adipisicing incididunt culpa aute nulla
                ut commodo officia. Dolor nostrud do duis et eiusmod laborum ipsum.
                Labore consequat ipsum aliquip et sunt proident.
              </p>
            </div>
            <div class="card-block project-checklist">
              <h4 class="project-checklist-title project-option-title">
                <button type="button" class="btn btn-pure btn-default icon md-delete btn-trash"></button>
              ...
              <div class="checkbox-custom checkbox-primary m-b-15">
              ...
              <div class="project-checklist-add bg-blue-grey-200">
                <form>
                  ...
                  <div class="operations">
                    ...
                    <button type="button" class="btn btn-pure btn-default icon md-delete p-0 btn-trash m-l-10"></button>
                  </div>
                </form>
              </div>
            </div>
              ...
              <div class="comments">
                <div class="comment media">
                  ...
                  <div class="comment-body media-body">
                    ...
                    <div class="comment-content">
                      <p>
                        Deserunt ullamco officia consequat deserunt dolore sunt laboris officia excepteur.
                        Officia labore aute fugiat duis nulla ad. Veniam qui elit
                        eiusmod cupidatat culpa consectetur in ex. Sunt laboris
                        velit enim duis. Aliqua ea aliqua qui fugiat quis laboris
                        irure. Nostrud sint elit velit laborum laboris aliquip
                        qui aute incididunt. Ipsum labore proident velit labore.
                        Culpa cillum cillum sint ea proident voluptate ullamco
                        sit.
                      </p>
                      <button type="button" class="btn btn-pure btn-default icon md-edit p-0 btn-edit">
                      </button>
                      <button type="button" class="btn btn-pure btn-default icon md-delete p-0 btn-trash">
                      </button>
                    </div>
                    <div class="comment-actions text-xs-left">
                      <a href="javascript:void(0)" role="button">Replay</a>
                      <a>
                        <i class="icon md-chevron-down"></i>
                        <span class="pos-number m-x-5">1</span>
                ...
                <div class="comment media">
                  ...
                  <div class="comment-body media-body">
                    ...
                    <div class="comment-content">
                      <p>
                        Aliqua dolor fugiat do ut cillum nulla enim ad. Anim ut elit sit ipsum id. Officia
                        laboris ad sunt fugiat. Proident nulla dolor culpa consequat
                        eu adipisicing consectetur nulla. Minim veniam non aute
                        ad minim sunt cupidatat do. Proident id ullamco do magna
                        officia et Lorem irure. Eu anim ut anim elit. Ea laborum
                ...
                <div class="comment media">
                  ...
                  <div class="comment-body media-body">
                    ...
                    <div class="comment-content">
                      <p>
                        Do aliquip anim in ipsum irure. Labore ex dolore reprehenderit nulla aute culpa.
                        Ex qui laboris officia enim aute velit culpa. Amet cupidatat
                        commodo in Lorem cillum aliquip nostrud. Enim officia eu
                        elit elit irure proident labore dolor duis. Ad aute eiusmod
                        deserunt do nulla. Nisi aliqua sunt excepteur minim. Esse
                        deserunt Lorem anim reprehenderit do fugiat laborum proident
                        velit.
                      </p>
                      <button type="button" class="btn btn-pure btn-default icon md-edit p-0 btn-edit">
                      </button>
                    ...
                    <div class="comment-actions text-xs-left">
                      ...
                      <a>
                        <i class="icon md-chevron-down"></i>
                        <span class="neg-number m-x-5">-5</span>
                        <i class="icon md-chevron-up"></i>
                      </a>
                    </div>
                  </div>
                ...
                <div class="comment media">
                  ...
                  <div class="comment-body media-body">
                    ...
                    <div class="comment-content">
                      <p>
                        Adipisicing proident aliquip non tempor fugiat nostrud fugiat. Quis tempor officia
                        ea tempor pariatur. Fugiat est proident magna qui aliqua
                        esse ex do. Adipisicing enim eu quis excepteur ut dolor
                        elit. Commodo aliqua qui culpa eu. Irure esse nulla deserunt
                        aliquip labore qui labore. Enim tempor nulla mollit ex
                        anim veniam occaecat. Duis officia anim exercitation occaecat
                        labore duis sunt.
                      </p>
                      <button type="button" class="btn btn-pure btn-default icon md-edit p-0 btn-edit">
                      </button>
                    ...
                    <div class="comment-actions text-xs-left">
                      ...
                      <a>
                        <i class="icon md-chevron-down"></i>
                        <span class="pos-number m-x-5">3</span>
                        <i class="icon md-chevron-up"></i>
                      </a>
                    </div>
                  </div>
                </div>
                <div class="comments-add media m-t-25">
                  ...
                  <div class="media-body">
                    <form action="#" method="post">
                      <div class="comment-summernote-custom form-group">
                        <div data-plugin="summernote" data-plugin-options='{"toolbar":[["style", ["bold", "italic", "underline", "clear"]],["color", ["color"]],["para", ["ul", "ol", "paragraph"]]]}'>
                          ...
                          <p>Lorem ipsum dolor sit amet,
                            <strong><b>consectetur adipisicing elit</b></strong>consectetur
                            adipisicing elit, sed do eiusmod tempor incididunt
                            ut labore et dolore magna aliqua. Ut enim ad minim
                            veniam, quis nostrud <u>Exercitation</u> ullamco laboris
                      ...
                      <div class="form-group">
                        <div class="dropdown dropup comment-visibility">
                          <button type="button" class="btn btn-pure btn-default dropdown-toggle p-0" data-toggle="dropdown"
                          aria-expanded="false">
                            <i class="icon md-lock"></i>
                          </button>
                          <div class="dropdown-menu" role="menu">
                        ...
                        <span class="blue-grey-400">View by All Users</span>
                      </div>
                      <div class="form-group m-b-0">
                        <button type="submit" class="btn btn-primary m-r-10">Send</button>
                        <button type="reset" class="btn btn-default">Clear</button>
                        <div class="dropdown dropup comment-attach">
                          <button type="button" class="btn btn-pure btn-primary" data-toggle="dropdown" aria-expanded="false">Attach
                          </button>
                          <div class="dropdown-menu bullet dropdown-menu-right" role="menu">
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem">
                              <i class="icon md-camera" aria-hidden="true"></i>                              Photo
                            </a>
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem">
                              <i class="icon md-tv-play" aria-hidden="true"></i>                              Video
                            </a>
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem">
                              <i class="icon md-volume-high" aria-hidden="true"></i>                              Audio
                            </a>
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem">
                              <i class="icon md-file" aria-hidden="true"></i> Document
                            </a>
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem">
                              <i class="icon md-map" aria-hidden="true"></i> Map
                            </a>
                          </div>
                        </div>
                      </div>
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-12 col-xs-12">
          <div class="card">
            <div class="card-block">
              <p class="m-b-10">
                <span class="pull-xs-right p-l-10">4h 30m</span>
                Time estimated
              </p>
              <p>
                <span class="pull-xs-right p-l-10">2h 10m</span>
                Time working
              </p>
              </ul>
            ...
            <div class="card-block">
              ...
              <span class="tag tag-default m-r-5 m-b-5">Default</span>
              <span class="tag tag-primary m-r-5 m-b-5">Primary</span>
              <span class="tag tag-success m-r-5 m-b-5">Success</span>
              <span class="tag tag-info m-r-5 m-b-5">Info</span>
              <span class="tag tag-warning m-r-5 m-b-5">Warning</span>
              <span class="tag tag-danger m-r-5 m-b-5">Danger</span>
              <span class="tag tag-dark m-r-5 m-b-5">Dark</span>
            </div>
            <div class="card-block">
            ...
            <div class="card-block project-participators">
              ...
              <div class="media m-t-0">
                ...
                <div class="media-body">
                  ...
                  <span class="font-size-16 m-l-5">Tim Collins</span>
                </div>
              </div>
              <div class="media">
                <div class="media-left text-middle">
            ...
            <div class="card-block">
              ...
              <span class="p-r-50">Future Sprint</span>
              <span>Sprit - Signature</span>
              <a href="#" class="project-agility-view">View on Board</a>
            </div>
            <div class="card-block project-fast-operation">
              <a href="#">
                <i class="icon md-check-circle m-r-10"></i>
                <span>Create checklist</span>
              </a>
              <a href="#">
                <i class="icon md-notifications m-r-10"></i>
                <span>Due date</span>
              </a>
              <a href="#">
                <i class="icon md-folder m-r-10"></i>
...
<!-- Mirrored from myadmin2.appavent.com/pages/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:46 GMT -->
</html>