...
<!-- Mirrored from myadmin2.appavent.com/pages/code-editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:29 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title>Code Editor | Remark Admin Template</title>
  ...
  <link rel="stylesheet" href="../global/vendor/jquery-mmenu/jquery-mmenu.css">
  <link rel="stylesheet" href="../global/vendor/bootstrap-treeview/bootstrap-treeview.css">
  <link rel="stylesheet" href="../global/vendor/codemirror/codemirror.css">
  <link rel="stylesheet" href="../global/vendor/codemirror/addon/scroll/simplescrollbars.css">
...
<body class="animsition site-navbar-small page-code-editor page-aside-scroll page-aside-left">
  <!--[if lt IE 8]>
...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <script src="../../ajax.googleapis.com/ajax/libs/jquery/jquery.min.html"></script>
        <script>window.jQuery || document.write('<script src="js/vendor/jquery-.min.html"><\/script>')</script>
...
<!-- Mirrored from myadmin2.appavent.com/pages/code-editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:32 GMT -->
</html></textarea>
      </div>
    </div>
    ...
    <div id="filesContextMenu">
      <div class="dropdown-menu" role="menu">
        <a class="dropdown-item" tabindex="-1"><i class="icon md-edit" aria-hidden="true"></i> Rename...</a>
        <a class="dropdown-item" tabindex="-1"><i class="icon md-search" aria-hidden="true"></i> Find in...</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" tabindex="-1"><i class="icon md-file" aria-hidden="true"></i> New File</a>
        <a class="dropdown-item" tabindex="-1"><i class="icon md-folder" aria-hidden="true"></i> New Folder...</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" tabindex="-1"><i class="icon md-close" aria-hidden="true"></i> Deleted...</a>
      </div>
    </div>
  </div>
  <!-- Footer -->
  ...
  <script src="../global/vendor/bootstrap-treeview/bootstrap-treeview.min.js"></script>
  <script src="../global/vendor/codemirror/codemirror.js"></script>
  <script src="../global/vendor/codemirror/addon/scroll/simplescrollbars.js"></script>
  <script src="../global/vendor/codemirror/mode/xml/xml.js"></script>
  <script src="../global/vendor/codemirror/mode/css/css.js"></script>
  <script src="../global/vendor/codemirror/mode/htmlmixed/htmlmixed.js"></script>
  <script src="../global/vendor/bootstrap-contextmenu/bootstrap-contextmenu.js"></script>
  <!-- Scripts -->
  ...
  <script src="../global/js/Plugin/bootstrap-treeview.js"></script>
  <script src="../assets/examples/js/pages/code-editor.js"></script>
</body>
</html>