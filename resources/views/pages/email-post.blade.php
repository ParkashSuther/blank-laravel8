...
<!-- Mirrored from myadmin2.appavent.com/pages/email-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:29 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title>Single Post | Remark Admin Template</title>
  ...
  <link rel="stylesheet" href="../global/vendor/jquery-mmenu/jquery-mmenu.css">
  <link rel="stylesheet" href="../assets/examples/css/pages/email.css">
  <!-- Fonts -->
...
<body class="animsition site-navbar-small page-email page-email-post">
  <!--[if lt IE 8]>
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
          <div class="email-title">
            ...
            <h4 class="blue-grey-400 font-weight-400">Remark</h4>
          </div>
          <div class="card">
            <div class="card-block p-x-0">
              <div class="card m-b-0">
                <div class="card-header cover overlay p-0">
                  <img class="cover-image" src="../global/photos/placeholder.png" alt="...">
                  <div class="overlay-shade overlay-panel"></div>
                </div>
                <div class="card-block p-x-0">
                  <h3 class="card-title">Dolemus vero fames</h3>
                  <p class="card-text">
                    <small>Jun 15, 2016</small>
                  </p>
                  <p class="card-text">Personae romano, deditum, diu veniam totam aequo, voluptaria
                    maluisset cotidie gravis quando liberiusque placatae, ars dicitis
                    potius, ordiamur aegritudo conquisitis sicine omnibus specie
                    habendus iuvaret contemnere brute, concedo potuimus tractatas
                    inquam effici. Praeclara responsum provocatus m domo desiderat.
                    Quid natum. </p>
                </div>
                <div class="card-block p-0">
                  tags:
                  <a class="btn btn-default btn-outline m-x-5" href="#">Blog</a>
                  <a class="btn btn-default btn-outline m-x-5" href="#">Design</a>
                  <a class="btn btn-default btn-outline m-x-5" href="#">Cool</a>
                </div>
                <div class="card-block p-x-0 clearfix">
                  <a class="btn btn-default btn-outline card-link" href="javascript:void(0)"><i class="icon md-chevron-right font-size-16"></i>Read More</a>
                ...
                <div class="card-block p-x-0">
                  ...
                  <div class="card-block p-0">
                    <div class="media">
                      ...
                      <div class="media-body">
                        <div class="media-heading" href="#">
                          Herman Beck
                          <small>Yesterday at 12:30AM</small>
                        </div>
                        <small>Officia qui commodo ad dolor. Sit nisi minim aute deserunt
                          quis. Cupidatat ea officia in proident non. Mollit id
                          sit aliqua laborum. Officia labore dolor irure amet.
