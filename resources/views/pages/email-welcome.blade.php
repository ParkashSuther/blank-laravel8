...
<!-- Mirrored from myadmin2.appavent.com/pages/email-welcome.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:28 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title>Welcome | Remark Admin Template</title>
...
<body class="animsition site-navbar-small page-email page-email-welcome">
  <!--[if lt IE 8]>
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
          ...
          <div class="card welcome-content">
            <div class="card-block p-l-40 p-r-40  m-t-30 m-b-30">
              <h2>Welcome to Remark!</h2>
              <p>
                Thank you for signing up with awesome co! We hope you enjoy your time with us.
                Check out some of our newest offers below or the button to view
                your new account.
              </p>
              <a class="btn btn-primary" href="#">My Account</a>
            </div>
            <div class="card-block">
              <h3>Check out our newest sales!</h3>
              <div class="row">
                <div class="col-md-6 col-xs-12">
                  <div class="card card-shadow card-bordered">
                    ...
                    <div class="card-block">
                      <h3 class="card-title">Genus Quaerimus</h3>
                      ...
                      <p class="card-text">Dolemus late utriusque fore eveniet provincia spernat dissentiet.
                        Fit intemperantes.</p>
                    </div>
                    <div class="card-block">
                      <button type="button" class="btn btn-outline btn-primary card-link">Read more</button>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xs-12">
...
<!-- Mirrored from myadmin2.appavent.com/pages/email-welcome.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:29 GMT -->
</html>