...
<!-- Mirrored from myadmin2.appavent.com/pages/email-articles.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:28 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title>Articles | Remark Admin Template</title>
...
<body class="animsition site-navbar-small page-email page-email-articles">
  <!--[if lt IE 8]>
        ...
        <div class="panel-body container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-block p-0">
              <h4 class="card-title">Dissensio placebit bonarum</h4>
              <p class="card-text">Fecerit amici quale arte opinor homero, amaret amici audeam locupletiorem
              ...
              <a class="btn btn-primary card-link" href="javascript:void(0)">Read More</a>
            </div>
          </div>
          <div class="card">
            <div class="card-img-top cover">
            ...
            <div class="card-block p-0">
              <h4 class="card-title">Huius existimare ferantur</h4>
              <p class="card-text">Inquam maluisti corrigere operosam expectamus, sic facilis aiebat.
          ...
          <div class="card">
            ...
            <div class="card-block p-0">
              <h4 class="card-title">Assiduitas totum sanciret</h4>
              <p class="card-text">Multis vestra feci clariora caret proprius totum quaeso nati iudex,
          ...
          <div class="email-more">
            <h2 class="email-more-title">You May Want To Learn</h2>
