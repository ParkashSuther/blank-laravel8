...
<!-- Mirrored from myadmin2.appavent.com/pages/login-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:22 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <div class="page-content">
      ...
      <div class="page-login-main">
        <div class="brand hidden-md-up">
          <img class="brand-img" src="../assets/images/logo-blue%402x.png" alt="...">
          <h3 class="brand-text font-size-40">Remark</h3>
        </div>
        <h3 class="font-size-24">Sign In</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
        <form method="post" action="https://myadmin2.appavent.com/pages/login-v2.html" autocomplete="off">
...
<!-- Mirrored from myadmin2.appavent.com/pages/login-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:23 GMT -->
</html>