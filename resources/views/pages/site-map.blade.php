...
<!-- Mirrored from myadmin2.appavent.com/pages/site-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:41 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title>Site Map | Remark Admin Template</title>
  ...
  <link rel="stylesheet" href="../global/vendor/jquery-mmenu/jquery-mmenu.css">
  <link rel="stylesheet" href="../assets/examples/css/pages/site-map.css">
  <!-- Fonts -->
  ...
  <div class="page">
    ...
    <div class="page-content container-fluid">
      <div class="panel">
        <div class="panel-body">
          <div class="row">
            <div class="col-xxl-3 col-lg-6 col-md-6 col-xs-12">
              <!-- Sitemap List -->
              <h4>General</h4>
              <ul class="sitemap-list">
                <li>
                  <a href="../index.html">
                    <i class="md-view-dashboard m-r-10"></i>
                    <span>Dashboard</span>
                  </a>
                  <!-- Sitemap Children -->
                </li>
                <li>
                  <a href="#">
                    <i class="md-view-compact m-r-10"></i>
                    <span>Layouts</span>
                  </a>
                  <!-- Sitemap Children -->
                  <ul>
                    <li>
                      <a href="../layouts/menu-collapsed.html">
                        <i class="icon md-link pull-xs-right"></i>
                ...
                <li>
                  <a href="#">
                    <i class="md-google-pages m-r-10"></i>
                    <span>Pages</span>
                  </a>
                  <!-- Sitemap Children -->
                  <ul>
            ...
            <div class="col-xxl-3 col-lg-6 col-md-6 col-xs-12">
              ...
              <ul class="sitemap-list">
                ...
                <li>
                  <a href="#">
                    <i class="md-format-color-fill m-r-10"></i>
                ...
                <li>
                  <a href="#">
                    <i class="md-puzzle-piece m-r-10"></i>
                    <span>Structure</span>
                  </a>
                  <!-- Sitemap Children -->
                  <ul>
                ...
                <li>
                  <a href="#">
                    <i class="md-comment-alt-text m-r-10"></i>
                    <span>Forms</span>
                  </a>
                  <!-- Sitemap Children -->
                  <ul>
                ...
                <li>
                  <a href="#">
                    <i class="md-border-all m-r-10"></i>
                    <span>Tables</span>
                  </a>
                  <!-- Sitemap Children -->
                  <ul>
