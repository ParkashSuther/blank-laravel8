...
<!-- Mirrored from myadmin2.appavent.com/pages/profile-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:37 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title>Profile v3 | Remark Admin Template</title>
...
<body class="animsition site-navbar-small page-profile-v3">
  <!--[if lt IE 8]>
      ...
      <li class="site-menu-item has-sub active">
        ...
        <ul class="site-menu-sub">
          ...
          <li class="site-menu-item has-sub">
            ...
            <ul class="site-menu-sub">
              <li class="site-menu-item">
                <a class="animsition-link" href="email-articles.html">
                  <span class="site-menu-title">Articles</span>
                </a>
              </li>
              <li class="site-menu-item">
                <a class="animsition-link" href="email-welcome.html">
                  <span class="site-menu-title">Welcome</span>
                </a>
              </li>
              <li class="site-menu-item">
                <a class="animsition-link" href="email-post.html">
                  <span class="site-menu-title">Post</span>
                </a>
              </li>
              <li class="site-menu-item">
                <a class="animsition-link" href="email-thumbnail.html">
                  <span class="site-menu-title">Thumbnail</span>
                </a>
              </li>
              <li class="site-menu-item">
                <a class="animsition-link" href="email-news.html">
          ...
          <li class="site-menu-item">
            <a class="animsition-link" href="profile-v2.html">
          ...
          <li class="site-menu-item active">
            <a class="animsition-link" href="profile-v3.html">
      ...
      <div class="row">
        <div class="col-lg-8 col-xs-12">
            ...
            <div class="card-block p-0">
              <div class="form-group m-b-0">
                ...
                <div class="p-10">
                  ...
                  <button class="btn btn-primary btn-round submit pull-xs-right m-r-10">
                    Post
                  </button>
                </div>
              </div>
          ...
          <div class="card card-shadow">
            <div class="card-block media clearfix p-25">
              ...
              <div class="media-body text-middle">
                ...
                <small>Posted on 31st Aug 2016 at 07:00</small>
              </div>
            </div>
            <div class="card-block p-x-25  p-t-0">
              <p class="card-text m-b-20">
                Exercitation et proident esse adipisicing commodo. Velit sint proident ex nisi
                irure. Consectetur laboris deserunt elit deserunt anim. Sunt velit
                commodo adipisicing pariatur enim. Mollit excepteur aliquip nulla
                sint esse tempor duis. Fugiat veniam in excepteur velit ex proident
                veniam. Sunt nisi deserunt reprehenderit mollit incididunt. Consequat
                exercitation id amet voluptate.
              </p>
              <div class="row imgs-gallery m-b-20 no-space">
                <div class="col-lg-12">
                  <a href="../global/photos/animal-2-960x640.html" alt="..." class="gallery-item"
                  data-img-id="m_1" title="view_1">
                    <img src="../global/photos/animal-2-960x640.html" class="w-full">
                  </a>
                </div>
              </div>
              <ul class="wall-attrs clearfix p-0 m-0">
                <li class="attrs-meta pull-xs-left">
                  <span>
                    <i class="icon md-chat"></i> 36
                  </span>
                  <span class="success m-l-10">
                    </if>
            ...
            <div class="card-footer p-20">
              <div class="wall-comment">
                <a href="#" class="avatar avatar-md pull-xs-left">
                  <img src="../global/portraits/3.jpg">
                </a>
                <div class="m-l-60">
                  <a href="#">Stacey Hunt</a>
                  <small class="m-l-10">30th July 2016</small>
                  <p class="m-t-5">
                    Aliqua deserunt et irure aute. Cupidatat ad enim tempor pariatur nostrud ea ipsum.
                    In ut est pariatur aliqua cupidatat quis et. Ad aliqua velit
                    nostrud dolore non cillum.
                  </p>
                </div>
              ...
              <div class="wall-comment">
                ...
                <div class="m-l-60">
                  ...
                  <p class="m-t-5">
                    Enim in nisi nisi ipsum cillum. Ad commodo in ex commodo laboris cupidatat. Fugiat
                    irure dolore eiusmod enim in. Veniam ut duis eiusmod dolore
                    ea magna cillum.
                  </p>
                </div>
                <div class="dropdown comment-operation">
          ...
          <div class="card card-shadow">
            <div class="card-block media clearfix p-25">
              ...
              <div class="media-body text-middle">
                ...
                <small>Posted on 29th Aug 2016 at 02:10</small>
              </div>
            </div>
            <div class="card-block p-x-25  p-t-0">
              <p class="card-text m-b-20">
                Proident eu consectetur esse esse ex est eu irure aute. Elit deserunt et aute cillum
                voluptate ad sunt. Mollit voluptate proident ut Lorem ea nulla
                labore cupidatat. Officia quis pariatur incididunt consequat. Irure
                sunt consequat nulla nisi ex laboris minim ut. Magna occaecat laborum
                aliquip elit officia dolore dolore ut. Aliqua anim reprehenderit
                pariatur cupidatat tempor elit Lorem in nostrud. Minim labore pariatur
                ex eu excepteur quis.
              </p>
              <ul class="wall-attrs clearfix p-0 m-0">
                <li class="attrs-meta pull-xs-left">
                  <span>
          ...
          <div class="card card-shadow">
            <div class="card-block media clearfix p-25">
              ...
              <div class="media-body text-middle">
                ...
                <small>Posted on 2nd on Jul 2016 at 02:10</small>
              </div>
            </div>
            <div class="card-block p-x-25  p-t-0">
              <p class="card-text m-b-20">
                In proident dolor ut ipsum culpa non commodo laborum. Anim amet in occaecat irure
                velit consequat cillum ut cillum. Consectetur esse irure laborum
                ut incididunt Lorem esse est occaecat. Commodo ullamco eiusmod
                ad dolore consectetur aute velit. Consectetur cillum ea voluptate
                ut eiusmod. Id id ipsum reprehenderit nostrud voluptate excepteur
                exercitation. Irure quis laborum duis cillum sint nisi quis laboris
                ad. Consequat dolor sit veniam fugiat voluptate labore cillum dolore
                dolore.
              </p>
              <div class="row imgs-gallery m-b-20 no-space">
                <div class="col-xl-4 col-lg-6 col-xs-12">
                  <a href="../global/photos/city-2-720x480.html" alt="..." class="gallery-item"
                  data-img-id="m_1" title="view_1">
                    <img src="../global/photos/city-2-720x480.html" class="w-full">
                  </a>
                </div>
                <div class="col-xl-4 col-lg-6 col-xs-12">
                  <a href="../global/photos/city-3-720x480.html" alt="..." class="gallery-item"
                  data-img-id="m_2" title="view_2">
                    <img src="../global/photos/city-3-720x480.html" class="w-full">
                  </a>
                </div>
                <div class="col-xl-4 col-lg-6 col-xs-12">
                  <a href="../global/photos/city-4-720x480.html" alt="..." class="gallery-item"
                  data-img-id="m_3" title="view_3">
                    <img src="../global/photos/city-4-720x480.html" class="w-full">
                  </a>
                </div>
                <div class="col-xl-6 col-lg-6 col-xs-12">
                  <a href="../global/photos/city-5-720x480.html" alt="..." class="gallery-item"
                  data-img-id="m_4" title="view_4">
                    <img src="../global/photos/city-5-720x480.html" class="w-full">
                  </a>
                </div>
                <div class="col-xl-6 col-lg-12 col-xs-12">
                  <a href="../global/photos/animal-1-720x480.html" alt="..." class="gallery-item"
                  data-img-id="m_5" title="view_5">
                    <img src="../global/photos/animal-1-720x480.html" class="w-full">
                  </a>
                </div>
              </div>
              <ul class="wall-attrs clearfix p-0 m-0">
            ...
            <div class="card-footer p-20">
              <div class="wall-comment">
                ...
                <div class="m-l-60">
                  ...
                  <small class="m-l-10">30th July 2016</small>
                  <p class="m-t-5">
                    Elit consectetur nostrud fugiat aliquip. Id incididunt consequat dolore laborum
                    ipsum anim excepteur anim. Excepteur nisi occaecat anim dolor
                    et officia ea laborum. Veniam consectetur ea do laborum consectetur
                    consequat esse.
                  </p>
                </div>
                <div class="dropdown comment-operation">
          ...
          <div class="card card-shadow">
            <div class="card-block media clearfix p-25">
              ...
              <div class="media-body text-middle">
                ...
                <small>Posted on 2nd Sep 2016 at 17:00</small>
              </div>
            </div>
            <div class="card-block p-x-25  p-t-0">
              <p class="wall-note">Added a new video</p>
              <p class="card-text m-b-20">
                Occaecat labore sunt ea in. Duis nisi consequat velit amet labore esse magna ut.
                Incididunt velit cillum culpa minim culpa. Occaecat voluptate est
                dolor nulla mollit consequat aliquip enim veniam. Tempor magna
                officia commodo laborum ad laborum labore. Aliqua incididunt deserunt
                culpa do nostrud velit. Qui amet reprehenderit est eu in. Duis
                incididunt adipisicing non ad.
              </p>
              <div class="row m-b-20 no-space">
                <div class="col-xxl-6 col-xl-12">
                  <div class="cover player" data-plugin="plyr" data-video-id="v_1">
                    <video poster="../assets/examples/images/poster.jpg" controls crossorigin>
                      ...
                      <!-- Text Track File -->
                      <track kind="captions" label="English" srclang="en" src="http://cdn.selz.com/plyr/1.0/en.vtt"
                      default>
            ...
            <div class="card-footer p-20">
              <div class="wall-comment">
                ...
                <div class="m-l-60">
                  ...
                  <small class="m-l-10">30th July 2016</small>
                  <p class="m-t-5">
                    Velit dolore mollit eiusmod consectetur. Eu qui nisi ipsum proident ipsum pariatur
                    reprehenderit sunt. Laborum anim in cillum ad laborum sit cupidatat.
                    Mollit aute ullamco eiusmod pariatur sunt proident incididunt
                    exercitation sunt.
                  </p>
                </div>
                <div class="dropdown comment-operation">
          ...
          <div class="card card-shadow">
            ...
            <div class="card-block p-x-25  p-t-0">
              ...
              <p class="card-text m-b-20">
                Non incididunt adipisicing culpa id veniam nostrud veniam. Pariatur excepteur duis
                consequat nostrud. Id tempor do sint ea amet ex fugiat labore.
                Quis deserunt amet voluptate cillum est. Et quis consectetur velit
                reprehenderit amet qui ad sint qui. Lorem pariatur ea minim eiusmod
                Lorem incididunt. Nisi officia deserunt minim nostrud veniam. Dolor
                aliquip elit cillum sunt nostrud deserunt cillum nulla culpa.
              </p>
              <div class="wall-body-audio clearfix">
                <div class="row m-b-20 no-space">
                  <div class="col-xxl-6 col-xl-12">
                    <div class="cover player" data-audio-id="">
                      <audio controls>
                        <!-- Audio Files -->
            ...
            <div class="card-footer p-20">
              <div class="wall-comment">
                ...
                <div class="m-l-60">
                  ...
                  <small class="m-l-10">30th July 2016</small>
                  <p class="m-t-5">
                    Tempor ex ullamco elit eu Lorem elit esse eu id. Amet exercitation elit officia
                    deserunt est nisi ex consectetur mollit. Reprehenderit culpa
                    enim esse eiusmod. Consectetur qui reprehenderit commodo commodo
                    ad esse.
                  </p>
                </div>
                <div class="dropdown comment-operation">
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="card card-block">
            ...
            <p class="card-text">
              Mollit exercitation ex exercitation fugiat. Et ex ea est consequat non quis. In
              duis aute ex Lorem laborum tempor culpa magna duis. Elit in commodo
              aute elit commodo fugiat culpa nostrud.
              <a href="#">Read more...</a>
            </p>
          </div>
          <div class="card wall-recent-comments">
            ...
            <div class="list-group">
              <a class="list-group-item" data-recomment-id="c_1">
                <div class="media">
                  <div class="media-left pull-xs-left p-r-15">
                    <img class="avatar avatar-md" src="../global/portraits/6.jpg">
                  </div>
                  <div class="media-body">
                    <h5 class="list-group-item-heading">David Belle</h5>
                    <p class="list-group-item-text">
                      Amet officia exercitation elit aliquip enim enim proident....
                    </p>
                  </div>
                </div>
              </a>
              <a class="list-group-item" data-recomment-id="c_2">
                <div class="media">
                  <div class="media-left pull-xs-left p-r-15">
                    <img class="avatar avatar-md" src="../global/portraits/7.jpg">
                  </div>
                  <div class="media-body">
                    <h5 class="list-group-item-heading">Jonathan Morris</h5>
                    <p class="list-group-item-text">
                      Incididunt in labore proident ex ea....
                    </p>
                  </div>
                </div>
              </a>
              <a class="list-group-item" data-recomment-id="c_3">
                <div class="media">
                  <div class="media-left pull-xs-left p-r-15">
                    <img class="avatar avatar-md" src="../global/portraits/4.jpg">
                  </div>
                  <div class="media-body">
                    <h5 class="list-group-item-heading">Fredric Mitchell Jr.</h5>
                    <p class="list-group-item-text">
                      Duis deserunt adipisicing voluptate tempor est excepteur veniam....
                    </p>
                  </div>
                </div>
              </a>
              <a class="list-group-item" data-recomment-id="c_4">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h5 class="list-group-item-heading">Jonathan Morris</h5>
                    <p class="list-group-item-text">
                      Amet minim voluptate adipisicing non culpa officia....
                    </p>
                  </div>
                </div>
              </a>
              <a class="list-group-item" data-recomment-id="c_5">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h5 class="list-group-item-heading">Fredric Mitchell Jr.</h5>
                    <p class="list-group-item-text">
                      Enim veniam ea velit excepteur culpa....
                    </p>
                  </div>
                </div>
              </a>
          ...
          <div class="card p-20">
            ...
            <div class="card-block p-0">
              <p data-info-type="phone" class="m-b-10 text-nowrap">
                <i class="icon md-account m-r-10"></i>
                <span class="text-break">00971123456789
                  <span>
              </p>
              <p data-info-type="email" class="m-b-10 text-nowrap">
                <i class="icon md-email m-r-10"></i>
                <span class="text-break">malinda.h@gmail.com
                  <span>
              </p>
              <p data-info-type="fb" class="m-b-10 text-nowrap">
                <i class="icon bd-facebook m-r-10"></i>
                <span class="text-break">malinda.hollaway
                  <span>
              </p>
              <p data-info-type="twitter" class="m-b-10 text-nowrap">
                <i class="icon bd-twitter m-r-10"></i>
                <span class="text-break">@malinda (twitter.com/malinda)
                  <span>
              </p>
              <p data-info-type="address" class="m-b-10 text-nowrap">
                <i class="icon md-pin m-r-10"></i>
...
<!-- Mirrored from myadmin2.appavent.com/pages/profile-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:41 GMT -->
</html>