...
<!-- Mirrored from myadmin2.appavent.com/pages/email-thumbnail.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Dec 2021 13:24:29 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <title>Post Thumbnail | Remark Admin Template</title>
...
<body class="animsition site-navbar-small page-email page-email-thumbnail">
  <!--[if lt IE 8]>
          ...
          <div class="card-list m-t-20">
            <div class="card card-list-item">
              <div class="card-img-left">
                <div class="cover-background" style="background-image: url('../global/photos/placeholder.png')"></div>
              </div>
              <div class="card-block">
                <p class="card-text">
                  <small>
                    <span class="card-author">June Lane</span> /
                    <span class="card-category">News</span> /
                    <span class="card-time">Jun 21, 2016</span>
                  </small>
                </p>
                <h4 class="card-title">Plurimum attico latine</h4>
                <p class="card-text">Pervenias fatendum epicureis parentes tollit nostra levis homini
                  quietus affirmatis, temperantiamque suscepi electram effectrices
                  miser nomini expetendam istis. Aristippi idque. </p>
              </div>
              <div class="card-block clearfix">
                <div class="card-actions pull-xs-left">
                  <a href="javascript:void(0)">
                ...
                <a class="btn btn-outline btn-default card-link pull-xs-right" href="javascript:void(0)">
